...
@InputType()
class StoreReviewsCreateNestedManyWithoutVisitorsInput {
...
export { StoreReviewsCreateNestedManyWithoutVisitorsInput as StoreReviewsCreateNestedManyWithoutVisitorsInput };

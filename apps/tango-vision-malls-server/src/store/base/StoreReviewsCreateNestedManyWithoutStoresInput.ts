...
@InputType()
class StoreReviewsCreateNestedManyWithoutStoresInput {
...
export { StoreReviewsCreateNestedManyWithoutStoresInput as StoreReviewsCreateNestedManyWithoutStoresInput };

    ...
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        warrantyExpirationDate:
          CREATE_RESULT.warrantyExpirationDate.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          warrantyExpirationDate:
            FIND_MANY_RESULT[0].warrantyExpirationDate.toISOString(),
        },
      ]);
  });
  ...
  test("GET /assets/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        warrantyExpirationDate:
          FIND_ONE_RESULT.warrantyExpirationDate.toISOString(),
      });
  });
